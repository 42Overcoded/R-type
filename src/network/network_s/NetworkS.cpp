...
NetworkS::NetworkS(std::string ipServer, int portServer)
{
    totalReceived = 0;
    cliMessage[500] = 0;
    _ipServer = ipServer;
...
void NetworkS::listen_info_from_clients(registry *reg)
{
    while (true) {
...
int NetworkS::send_info_to_client(void *strucToServer)
{
