...
\DoxyHorRuler{0}
\hypertarget{md_rfc_autotoc_md43}{}\doxysection{Game Transmission Protocol (\+GTP)}\label{md_rfc_autotoc_md43}
\hypertarget{md_rfc_autotoc_md44}{}\doxysubsection{Status of this Memo}\label{md_rfc_autotoc_md44}
This memo is the official specification of the Game Transmission Protocol (GTP).

Distribution of this memo is unlimited.\hypertarget{md_rfc_autotoc_md45}{}\doxysubsection{Index}\label{md_rfc_autotoc_md45}
...
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_rfc_autotoc_md46}{}\doxysubsection{Introduction}\label{md_rfc_autotoc_md46}
...
\end{DoxyCode}
\hypertarget{md_rfc_autotoc_md50}{}\doxysubsection{The GTP Model}\label{md_rfc_autotoc_md50}
...
{\ttfamily Flag} is a 4 bytes long (uint32\+\_\+t) number. It define the following message. {\ttfamily Size} is a 4 bytes long (uint32\+\_\+t) number. It describe the size in bit of the payload. Value of 0 in case of no payload. {\ttfamily Payload} is a structure containing different information. It will change depending of the value of the header.\hypertarget{md_rfc_autotoc_md51}{}\doxysubsection{Commands}\label{md_rfc_autotoc_md51}
...
\end{DoxyCode}
\hypertarget{md_rfc_autotoc_md52}{}\doxysubsubsection{Server\+Get\+Ping}\label{md_rfc_autotoc_md52}
...
Description \+: This command is used to check if the server is still alive.\hypertarget{md_rfc_autotoc_md53}{}\doxysubsubsection{Server\+Connect}\label{md_rfc_autotoc_md53}
...
Description \+: This command is used to connect to the server.\hypertarget{md_rfc_autotoc_md54}{}\doxysubsubsection{Server\+Update\+Controls}\label{md_rfc_autotoc_md54}
...
Description \+: This command is used to update the controls of the player.\hypertarget{md_rfc_autotoc_md55}{}\doxysubsubsection{Client\+Accepted}\label{md_rfc_autotoc_md55}
...
Description \+: This command is used to confirm the connection to the server.\hypertarget{md_rfc_autotoc_md56}{}\doxysubsubsection{Client\+Denied}\label{md_rfc_autotoc_md56}
...
Description \+: This command is used to deny the connection to the server.\hypertarget{md_rfc_autotoc_md57}{}\doxysubsubsection{Client\+Assign\+ID}\label{md_rfc_autotoc_md57}
...
Description \+: This command is used to assign an ID to the client.\hypertarget{md_rfc_autotoc_md58}{}\doxysubsubsection{Client\+Send\+Ping}\label{md_rfc_autotoc_md58}
...
Description \+: This command is used to check if the client is still alive. (Response to Server\+Get\+Ping)\hypertarget{md_rfc_autotoc_md59}{}\doxysubsubsection{Client\+Add\+Player}\label{md_rfc_autotoc_md59}
...
Description \+: This command is used to add a player to the game.\hypertarget{md_rfc_autotoc_md60}{}\doxysubsubsection{Client\+Remove\+Player}\label{md_rfc_autotoc_md60}
...
Description \+: This command is used to remove a player from the game.\hypertarget{md_rfc_autotoc_md61}{}\doxysubsubsection{Client\+Create\+Entity}\label{md_rfc_autotoc_md61}
...
Description \+: This command is used to create an entity in the game.\hypertarget{md_rfc_autotoc_md62}{}\doxysubsubsection{Client\+Update\+Entity}\label{md_rfc_autotoc_md62}
